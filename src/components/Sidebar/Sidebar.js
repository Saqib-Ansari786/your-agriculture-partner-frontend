    ...
    const fetchSeasons = async () => {
      try {
        const response = await axios.get(
          "http://127.0.0.1:8000/api/get-seasons",
          {
            withCredentials: true, // Include cookies with the request
          }
        );
      ...
      >
        <nav className="h-full flex flex-col">
          ...
          <ul className="flex-1 px-3">
            ...
            <SidebarItem
              text={"Season"}
              icon={<i className="fas fa-calendar mr-3 text-lg"></i>}
              expanded={expanded}
            >
              <ul
                className="ml-5 bg-white border border-green-500"
                style={{
                  position: "fixed",
                  top: "26px",
              ...
              >
                ...
                <li className="my-2 ml-2">
                  <button
                    onClick={() => openModal()}
                    className="bg-blueGray-600 hover:bg-green-500 text-white px-4 py-2 ml-2 mb-2"
                  >
                    + Add new season
                  </button>
                </li>
              ...
              >
                ...
                <div className="relative">
                  ...
                  {isDropdownVisible &&
                    ...
                    (
                      <div
                        className="absolute bg-white border border-red-600 rounded shadow-lg z-1000"
                        style={{
                          bottom: "8px",
                          position: "fixed",
                          left: expanded ? "15vw" : "5.5vw",
